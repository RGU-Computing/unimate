  ...
  async onGoogleButtonPress() {
    ...
    try {
      ...
      if (error.code === statusCodes.SIGN_IN_CANCELLED) {
        ...
        Alert.alert('Oops! An error has occurred.', error + '', [{text: 'OK'}]);
      }
    }
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={{textAlign: 'center', marginHorizontal: 24}}>
          Unimate is an app to support mental & physical wellbeing in students.
        </Text>
        <Text
          style={{textAlign: 'center', marginHorizontal: 24, marginTop: 24}}>
          Sign In to Continue!
        </Text>
        <GoogleSigninButton
          style={styles.button}
        ...
        />
        <Text style={styles.copyright} appearance="hint">
          © 2020-2021 Robert Gordon University
        </Text>
        <Text style={styles.copyright} appearance="hint">
