          ...
          <Tab
            ...
            <ScrollView style={{backgroundColor: 'white'}}>
              <Layout style={styles.container}>
                ...
                <Text>
                  <Text>
                    We have identified some services that you can contact if you
                    need help regarding your mental health. Feel free to contact
                    them because they are more than happy to help you in
                    everyway they can!
                  </Text>
                </Text>
                <Layout style={[styles.item, {backgroundColor: '#712177'}]}>
                  ...
                  <Text style={styles.desc}>
                    The Semicolon Effect is a mental health support group for
                    those struggling with any mental health issues. A
                    confidential and safe space to vent without been judged and
                    aims at creating collaborative healthy coping mechanisms.
                  </Text>
                  ...
                  <Text style={{color: '#FFFFFF'}}>
                    ...
                    <Text
                      ...
                      onPress={() =>
                        Linking.openURL('mailto:thesemicoloneffect@outlook.com')
                      }>
                ...
                <Layout style={[styles.item, {backgroundColor: '#1c8eef'}]}>
                  ...
                  <Text style={styles.desc}>
                    Sumithrayo, a Government approved charity was founded by the
                    Late Mrs. Joan De Mel in 1974. From its humble beginnings at
                    Deans Road, Colombo 10, on premises loaned by the Ceylon
                    Social Services League, Sumithrayo is now housed at no 60B
                    Horton Place, Colombo 07, which was gifted by it’s beloved
                    founder – Joan de Mel. The organization was incorporated by
                    an Act of Parliament No.10 of 1986.
                  </Text>
                  <Text style={{color: '#FFFFFF'}}>
                    ☎️{' '}
                    <Text
                  ...
                  <Text style={{color: '#FFFFFF'}}>
                    ...
                    <Text
                      ...
                      onPress={() =>
                        Linking.openURL('mailto:sumithra@sumithrayo.org')
                      }>
                ...
                <Layout style={[styles.item, {backgroundColor: '#17202A'}]}>
                  ...
                  <Text style={styles.desc}>
                    Shanthi Maargam aims to provide safe spaces to enhance young
                    people’s emotional well being and create opportunities for
                    learning and growth.
                  </Text>
                  <Text style={{color: '#FFFFFF'}}>
                    ☎️{' '}
                  ...
                  <Text style={{color: '#FFFFFF'}}>
                    ...
                    <Text
                      ...
                      onPress={() =>
                        Linking.openURL('mailto:shanthimaargam@gmail.com')
                      }>
