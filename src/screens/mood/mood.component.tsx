              ...
              {/* <View style={styles.progressContainer}>
                <View style={{flex: 1, flexDirection: 'row'}}>
                  <View>
                    {AppStorage.getEmotivityDetails().status ? (
                      ...
                      <Avatar
                        ...
                        source={require('../../assets/images/notCompleted.png')}
                      />
                    )}
                  </View>
                  <View>
                  <View style={{flex: 1, flexDirection: 'row'}}>
                    ...
                    <FontAwesomeIcon style={{marginLeft:'5%', marginVertical:'2%'}} size={15} color={'#FFFFFF'} icon={faSmile}/>
                    </View>
                    {AppStorage.getEmotivityDetails().status ? (
                      <Text appearance="hint" style={{textAlign: 'left'}}>
                        Completed
                      </Text>
                    ) : (
                      <Text appearance="hint" style={{textAlign: 'left'}}>
                ...
                <View style={{flex: 1, flexDirection: 'row', marginTop: '2%'}}>
                  <View>
                    {AppStorage.checkSayThanxTodayCompleted() != null ? (
                      <Avatar
                        style={{
                          height: 35,
                          width: 35,
                  ...
                  <View style={{flex: 1, flexDirection: 'row'}}>
                    ...
                    <FontAwesomeIcon style={{marginLeft:'5%', marginVertical:'2%'}} size={15} color={'#FFFFFF'} icon={faHandHoldingHeart}/>
                    </View>
                    {AppStorage.checkSayThanxTodayCompleted() != null ? (
                      <Text appearance="hint" style={{textAlign: 'left'}}>
                        Completed
